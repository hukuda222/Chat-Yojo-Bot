...
def load_words(filename):
    ...
    return np.array(df['text_ids'][201:], dtype=int), np.array(df['text_ids'][101:200], dtype=int), np.array(df['text_ids'][:100], dtype=int)
...
def main():
    ...
    train, val, test = load_words('./texts_ids.csv')
...
def redo():
    subprocess.call(["qsub", "job.sh", "--resume"])


if __name__ == '__main__':
    atexit.register(redo)
    main()
